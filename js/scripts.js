$(document).ready(function(){
	...
	$('.home-nav').html('<div class="nav-left"><div class="title"><a href="/">iNoticed</a></div><a href="' 
		+ datingLink + '">Dating</a><a href="' 
		+ kindnessLink + '">Kindness</a><a href="' 
		+ valuedLink + '">Valued</a></div>');

	//Dating Signed Out pages nav:
		$('.dating-signed-out-nav').html('<div class="nav-left"><div class="title"><a href="/">iNoticed</a></div><a href="' 
			+ datingLink + '">Dating</a><a href="' 
			+ kindnessLink + '">Kindness</a><a href="' 
			+ valuedLink + '">Valued</a></div><div class="nav-right"><a href="' 
			+ createAccountLink + '"><i class="fas fa-user-plus"></i>Create Account</a><a href="' 
			+ signInLink + '"><i class="fas fa-sign-in-alt"></i>Sign In</a></div>');

	//Dating Signed in pages nav:
		$('.dating-signed-in-nav').html('<div class="nav-left"><div class="title"><a href="/">iNoticed</a></div></div><div class="nav-right"><a href="' 
			+ messagesLink + '"><i class="fas fa-envelope" style="padding-right:0;"></i><sup class="msg-notification"></sup> Message<span class="grammar">s</span></a><a href="' 
			+ profileLink + '"><i class="fas fa-address-card"></i>Profile</a><a href="' 
			+ editProfileLink + '"><i class="fas fa-edit"></i>Edit Profile</a><a href="' 
			+ accountSettingsLink + '"><i class="fas fa-cog"></i>Account Settings</a><a href="' 
			+ logoutLink + '"><i class="fas fa-sign-out-alt"></i>Log Out</a></div>');
