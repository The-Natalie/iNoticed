...
if(isset($_POST["submit"])) {
    $check = getimagesize($_FILES["fileToUpload"][$username]["tmp_name"]);
    if($check !== false) {
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"][$username]["tmp_name"], $target_file)) {
        echo "The file ". basename( $_FILES["fileToUpload"][$username]["name"]). " has been uploaded.";
    } else {
